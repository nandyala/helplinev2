...
public class UserFormController extends BaseFormController {
  ...
  /**
   * Creates a new UserFormController object.
   */
   ...
   */
  @Autowired public void setRoleManager(final RoleManager roleManager) {
   ...
   */
  @InitBinder @Override protected void initBinder(final HttpServletRequest request,
   ...
   * @param   request  DOCUMENT ME!
   *
   * @return  load user object from db before web data binding in order to keep properties not populated from web post.
   */
  @ModelAttribute("user")
